...
const LeaveForm = ({ applyLeave }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call the applyLeave function (passed as a prop)
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="w-full mt-6 bg-gradient-to-r from-blue-600 to-purple-500 text-white py-3 px-4 rounded-md hover:scale-105 transform transition-all duration-300 shadow-md"
      >
        Apply
      </button>
    </form>
